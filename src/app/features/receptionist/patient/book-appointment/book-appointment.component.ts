...
onCategoryChange(): void {
  ...
  checkAvailability(): void {
     ...
     console.log('Booking appointment with:', this.selectedDoctor?.doctorId);
    this.router.navigate([
      'receptionist/patients/search/book-appointment/check-availability', this.selectedDoctor?.doctorId 
    ]);
